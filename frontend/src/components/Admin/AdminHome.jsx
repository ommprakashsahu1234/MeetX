            ...
            {(sidebarOpen || window.innerWidth < 1024) ? (
              <div className="bg-gray-700/50 border border-gray-600 rounded-xl lg:rounded-2xl p-3 lg:p-4">
                <div className="flex items-center gap-2 lg:gap-3">
                  ...
                  <div>
                    <p className="text-xs lg:text-sm font-medium text-gray-100 text-left">System Status</p>
                    <p className="text-xs text-gray-400 text-left">All systems operational</p>
                  </div>
                </div>
              </div>
            ) : (
                ...
                {(() => {
                  ...
                  return (
                    <div className="flex items-center gap-2 lg:gap-3">
                      ...
                      <div>
                        <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-100 text-left">
                          {activeTabConfig?.label || 'Welcome Admin'}
                        </h1>
                        <p className="text-xs sm:text-sm lg:text-base text-gray-400 hidden sm:block text-left">

    ...
    <div className="space-y-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-gray-800 border border-gray-700 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-md">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-100 text-left">User Complaints</h1>
            <p className="text-gray-400 text-sm sm:text-base text-left">Handle and respond to user complaints</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-6 text-xs sm:text-sm">
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-blue-300 text-left">{complaints.length}</p>
                <p className="text-blue-400 text-left">Total Complaints</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-2xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-yellow-300 text-left">
                  {complaints.filter(c => c.status === "pending").length}
                </p>
                <p className="text-yellow-400 text-left">Pending</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-blue-300 text-left">
                  {complaints.filter(c => c.status === "active").length}
                </p>
                <p className="text-blue-400 text-left">Active</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-green-400 text-left">Completed</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                  <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs sm:text-sm text-gray-400 truncate text-left">
                        ID: {complaint._id}

    ...
    <div className="space-y-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-gray-800 border border-gray-700 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-md">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-100 text-left">Reported Posts</h1>
            <p className="text-gray-400 text-sm sm:text-base text-left">Review and moderate reported content</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-6 text-xs sm:text-sm">
          <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-red-300 text-left">{reports.length}</p>
          ...
          <div className="bg-orange-500/10 border border-orange-500/20 rounded-2xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-orange-300 text-left">
          ...
          <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-green-300 text-left">
            ...
            {filteredReports.map(({ post, count }, index) => (
              ...
              >
                {actionLoading === post._id && (
                  ...
                  <div className="relative aspect-square overflow-hidden flex-shrink-0" title={post.authorId?.username}>
                  ...
                  <div className="absolute top-3 left-3">
                    <div className={`px-2 py-1 rounded-xl text-xs font-medium flex items-center gap-1 ${post.suspended
                ...
                <div className="p-4 flex flex-col flex-1">
                  ...
                  <div className="flex items-center justify-between text-xs sm:text-sm text-gray-400 mb-3">
                    <div className="flex items-center gap-1 truncate">
                      ...
                      <span className="truncate">Author: {post.authorId?.username || 'Unknown'}</span>
                    </div>
                  </div>

                  <button
                    className={`w-full py-2 px-3 rounded-xl text-sm sm:text-base font-medium transition-all duration-300 hover:scale-105 active:scale-95 flex items-center justify-center gap-2 mt-auto ${post.suspended
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-gray-800 border border-gray-700 rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <div className={`px-2 py-1 rounded-lg text-xs font-medium flex items-center gap-1 ${selectedPost.suspended
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="mb-6">
                <button
                  className={`w-full md:w-auto px-6 py-3 rounded-2xl font-semibold transition-all duration-300 hover:scale-105 active:scale-95 flex items-center gap-3 justify-center ${selectedPost.suspended
                    ? "bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-white"
                    : "bg-gradient-to-r from-red-500 to-red-600 hover:from-red-400 hover:to-red-500 text-white"
      ...
      {toast && (
        <div className="fixed top-6 right-4 sm:right-6 z-50 animate-in slide-in-from-top-2 duration-300 max-w-xs sm:max-w-sm">
          <div
            className={`px-6 py-4 rounded-2xl shadow-2xl border backdrop-blur-md ${toast.type === "success"
          ...
          >
            <div className="flex items-center gap-3">
              <div className={`w-2 h-2 rounded-full ${toast.type === "success" ? "bg-green-400" : "bg-red-400"
                } animate-pulse`}></div>

    ...
    <div className="space-y-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-gray-800 border border-gray-700 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-md">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-100 text-left">Manage Users</h1>
            <p className="text-gray-400 text-sm sm:text-base text-left">View and manage all platform users</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-6 text-xs sm:text-sm">
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-blue-300 text-left">{users.length}</p>
        ...
        {filteredUsers.length === 0 ? (
          ...
          <div className="space-y-4">
            {filteredUsers.map((user, index) => (
              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-6" title={user.username+"\n"+user.name}>
                  <div className="flex items-center gap-3 lg:gap-4 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1 sm:gap-2 mb-0.5">
                        <h3 className="text-base sm:text-lg font-bold text-gray-100 group-hover:text-purple-400 transition-colors duration-300 truncate text-left">
                          {user.username}
                        </h3>
                        {user.isVerified && (
                      ...
                      <p className="text-gray-300 font-medium truncate text-sm sm:text-base text-left">{user.name}</p>

          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mt-6 text-sm sm:text-base">
            ...
            <div className="bg-gray-500/10 border border-gray-500/20 rounded-2xl p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-gray-300 text-left">
                    {users.filter((user) => !user.isVerified).length}
                  </p>
            ...
            <div className="space-y-4">
              {filteredUsers.map((user, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 flex-1 min-w-0" title={user.name}>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <h3 className="text-base sm:text-lg font-bold text-gray-100 group-hover:text-green-400 transition-colors duration-300 truncate text-left">
                          @{user.username}
                        </h3>
                        {user.isVerified && (
                      ...
                      <p className="text-gray-300 font-medium truncate text-sm sm:text-base text-left">
                        {user.name}
                      </p>
                    </div>
                  </div>

                  <div className="flex-1 min-w-0 space-y-2 text-sm sm:text-base" title={user.name}>
